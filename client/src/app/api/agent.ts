...
const Basket={
    ...
    addItem: (productId:number, kolicina=1, datumIznajmljivanja='2024-06-06', datumVracanja='2025-06-06')=>requests.post(`basket?productId=${productId}&kolicina=${kolicina}&datumIznajmljivanja=${datumIznajmljivanja}&datumVracanja=${datumVracanja}`, {}),
