import { ListItem, ListItemAvatar, Avatar, ListItemText, Button, Card, CardActions, CardContent, CardMedia, Typography, CardHeader, styled, colors } from "@mui/material";
...
export default function ProductCard({products}:Props){
  ...
  const dispatch=useAppDispatch()
    ...
    <Button component={Link} to={`/catalog/${products.id}`}  size="small">Pregled</Button>
    </CardActions>
  </Card>
);
