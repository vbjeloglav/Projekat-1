    ...
    public partial class OrderEntityAdded : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BasketOprema", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cijena = table.Column<long>(type: "INTEGER", nullable: false),
                    Karakteristike = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BasketItems_BasketOprema_BasketId",
                        column: x => x.BasketId,
                        principalTable: "BasketOprema",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BasketItems_Oprema_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemOrderedIme = table.Column<string>(name: "ItemOrdered_Ime", type: "TEXT", nullable: true),
                    ItemOrderedSlika = table.Column<string>(name: "ItemOrdered_Slika", type: "TEXT", nullable: true),
                    Cijena = table.Column<long>(type: "INTEGER", nullable: false),
