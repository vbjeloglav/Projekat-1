...
namespace API.Data.MIgrations
{
    ...
    [Migration("20240619115007_OrderEntityAddedReserve")]
    partial class OrderEntityAddedReserve
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("API.Entities.OrderAggregate.OrderItem", b =>
                {
                    ...
                    b.Property<int?>("OrderRezervisanoId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("OrderRezervisanoId");

                    b.ToTable("OrderItem");
                });

            modelBuilder.Entity("API.Entities.OrderAggregate.OrderRezervisano", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("API.Entities.OrderAggregate.OrderItem", b =>
                {
                    ...
                    b.HasOne("API.Entities.OrderAggregate.OrderRezervisano", null)
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderRezervisanoId");
